    ...
    Message: Clone + core::fmt::Debug + 'static,
{
    pub fn new() -> Self {
        let close_icon = WidgetData::new(Box::new(SvgWidget::new(
            "/var/home/lain/Projects/ralaire/assets/icons/window-close-symbolic.svg",
        )));
        ...
        let maximise_icon = WidgetData::new(Box::new(SvgWidget::new(
            "/var/home/lain/Projects/ralaire/assets/icons/window-maximize-symbolic.svg",
        )));
        ...
        let minimise_icon = WidgetData::new(Box::new(SvgWidget::new(
            "/var/home/lain/Projects/ralaire/assets/icons/window-minimize-symbolic.svg",
        )));
